...
<div>
    ...
    <header class="sticky top-0 bg-white shadow dark:bg-gray-800 text-white">
        <div class="container flex sm:flex-row justify-between items-center mx-auto py-4 px-8">
            <div class="flex items-center text-2xl">
                Holytrinity-Academia
            </div>
            <div class="flex mt-4 sm:mt-0">
                <a class="px-4" href="#features">Messages</a>
        ...
        <section class="pt-20 md:pt-40">
            <div class="container mx-auto px-8 lg:flex">
                <div class="text-center lg:text-left lg:w-1/2">
                    <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">Main title of your
                        landing page</h1>
